...
class Detallecompra(models.Model):
    pk = models.CompositePrimaryKey('Id_Compra', 'ISBN')
    id_compra = models.ForeignKey(Compra, models.DO_NOTHING, db_column='Id_Compra')  # Field name made lowercase.
    isbn = models.ForeignKey('Libro', models.DO_NOTHING, db_column='ISBN')  # Field name made lowercase.
...
class Inventario(models.Model):
    pk = models.CompositePrimaryKey('Id_Local', 'ISBN')
    ...
    costo = models.DecimalField(db_column='Costo', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
